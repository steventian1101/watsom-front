        ...
        <div className="md:w-1/2">
          <div className="min-h-screen h-full flex flex-col after:flex-1">
            ...
            <div className="max-w-sm mx-auto px-4 py-8">
              <h1 className="text-3xl text-slate-800 font-bold mb-6">{t("welcome_back")}! ✨</h1>
              {/* Form */}
              <form>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium mb-1" htmlFor="email">{t("email_address")}</label>
